    ...
    <div class="app-container">
        ...
        <div class="table-container">
            ...
            <el-table v-if="refreshTable" v-loading="loading" :data="menuList" row-key="menuId"
                ...
                <el-table-column label="操作" align="left" width="160" fixed="right" class-name="small-padding fixed-width">
                    <template slot-scope="scope">
                        <el-link :underline="false" size="mini" type="text" @click="handleUpdate(scope.row)"
                            v-hasPermi="['system:menu:edit']">修改</el-link>
                        <el-link :underline="false" size="mini" type="text" @click="handleAdd(scope.row)"
                            v-hasPermi="['system:menu:add']">新增</el-link>
                        <el-link :underline="false" size="mini" type="text" @click="handleDelete(scope.row)"
                            v-hasPermi="['system:menu:remove']">删除</el-link>
                    </template>
                </el-table-column>
            </el-table>
        </div>
                    ...
                    <el-col :span="12" v-if="form.menuType != 'F'">
                        <el-form-item prop="visible">
                            ...
                            <el-radio-group v-model="form.visible">
                                <el-radio v-for="dict in dict.sys_show_hide" :key="dict.value" :label="dict.value">{{
                                    dict.label }}</el-radio>
                            </el-radio-group>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" v-if="form.menuType != 'F'">
                        <el-form-item prop="status">
                            ...
                            <el-radio-group v-model="form.status">
                                <el-radio v-for="dict in dict.sys_normal_disable" :key="dict.value"
