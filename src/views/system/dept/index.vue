        ...
        <el-table-column label="操作" align="left" width="160" fixed="right" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-link :underline="false" size="mini" type="text"  @click="handleUpdate(scope.row)"
              v-hasPermi="['system:dept:edit']">修改</el-link>
            <el-link :underline="false"  size="mini" type="text"  @click="handleAdd(scope.row)"
              v-hasPermi="['system:dept:add']">新增</el-link>
            <el-link :underline="false" v-if="scope.row.parentId != 0" size="mini" type="text"
              @click="handleDelete(scope.row)" v-hasPermi="['system:dept:remove']">删除</el-link>
          </template>
        </el-table-column>
      </el-table>
    </div>
